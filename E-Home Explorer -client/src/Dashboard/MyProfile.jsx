  ...
  return (
    <div className='flex flex-col justify-center items-center gap-6'>
      <h1 className='text-4xl font-bold font-serif text-center'>MyProfile</h1>
      {
        currentUser? 
        <div  className='flex flex-col justify-center items-center gap-6'>
          <h1 className='text-2xl font-semibold'>Name: {currentUser.name}</h1>
          <h1 className='text-2xl font-semibold'>Email: {currentUser.email}</h1>
          <h1 className='text-2xl font-semibold'> {currentUser?.role}</h1>
